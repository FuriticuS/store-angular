export const products = [
  {
    ...
    description: "Perferendis possimus voluptas tempora eius. Aut molestias modi suscipit ullam. Voluptatem excepturi ipsa recusandae dolorem.",
    ean: "9964026430849",
    upc: "150458448755",
    ...
    price: "5051.91",
    categories: [
      "96f6cd2f-a328-38cf-919b-dc798449d5e8",
      "b2e0f55d-e2fc-36bb-960a-19dd81ddf8fe",
      "7ca6380d-7279-324c-9e2c-f59af1028c09",
      "5e0714c4-d7d3-3587-a781-db4df7af55c3"
    ],
    tags: [
      "saepe",
      "adipisci",
